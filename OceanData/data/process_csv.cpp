...
// This is to process cvs data file
// Run as : ./process_csv AER_OD  MODAL2_M_AER_OD > AER_OD.$tag.log
// Program argument: durectory name, file prefix

struct regions {
  string name;
  float lat1, lat2; // latitude
  float long1, long2; // longitude
  float area;
  vector<int> dataCnt;
  vector < float> data;
...
int main (int argc, char *argv[]){
  ...
  // each downloaded group data has different start and end time 
